/*
 * el cliente se compila haciendo
 * gcc clienteTCPs.c -o clienteTCPs
 * y se ejecuta haciendo
 * ./clienteTCPs localhost
 * o local host puede ponerse la direccion ip del servidor
 * 
